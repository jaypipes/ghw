...
[![Build Status](https://github.com/adumandix/ghw/actions/workflows/go.yml/badge.svg?branch=main)](https://github.com/adumandix/ghw/actions)
[![Go Report Card](https://goreportcard.com/badge/github.com/adumandix/ghw)](https://goreportcard.com/report/github.com/adumandix/ghw)
...
* `ghw.MemoryInfo.Modules` is an array of pointers to `ghw.MemoryModule`
  ...
  [planned](https://github.com/adumandix/ghw/pull/171#issuecomment-597082409).
...
There has been [some](https://github.com/adumandix/ghw/pull/171)
[confusion](https://github.com/adumandix/ghw/issues/183) regarding the
...
> [planned](https://github.com/adumandix/ghw/issues/166).
...
in [#220](https://github.com/adumandix/ghw/issues/220), this was a misnomer.
...
```
[adumandix@uberbox ghw]$ make test
go test github.com/adumandix/ghw github.com/adumandix/ghw/cmd/ghwc
ok      github.com/adumandix/ghw 0.084s
?       github.com/adumandix/ghw/cmd/ghwc    [no test files]
```
